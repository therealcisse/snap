...
/**
 * One command's outcome plus the invocation-level details that are no command's success
 * shape: `merge` (§7.8) is the only producer of warnings — §6.4 auto-resolution details — and
 * they travel beside the record to `render`'s warnings parameter.
 */
